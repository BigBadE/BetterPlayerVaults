...
public final class ReflectionUtils {
    ...
    public static <T> T invokeMethod(Method method, Object target,
        ...
        try {
            ...
            PlayerVaults.getPluginLogger().log(Level.SEVERE, "Could not call method",
                    e);
            return null;
        }
    }
    ...
    public static <T> T getValue(Field field, Object target) {
        try {
            ...
            PlayerVaults.getPluginLogger().log(Level.SEVERE, "Error getting field",
                    e);
            return null;
        }
    }
    ...
    public static <T> T instantiate(Class<T> clazz, Object... args) {
        ...
        try {
            return Objects.requireNonNull(getConstructor(clazz, params))
                    .newInstance(args);
