...
public abstract class BasicCommand<T extends CommandSender> implements CommandExecutor {
    ...
    public void getPlayer(T player, String name, Consumer<Player> onlinePlayer, Consumer<OfflinePlayer> offlinePlayer) {
